...
st.markdown(f'<h1 style="color:#D2691E;font-size:28px;">{"Negative Coef Count-Vectoriser Words LR Model Output"}</h1>', unsafe_allow_html=True)
st.write(neg)

st.markdown(f'<h1 style="color:#D2691E;font-size:28px;">{"Positive Coef Count-Vectoriser Words LR Model Output"}</h1>', unsafe_allow_html=True)
...
st.markdown(f'<h1 style="color:#D2691E;font-size:28px;">{"Negative Coef TF-IDF Words LR Model Output"}</h1>', unsafe_allow_html=True)
st.write(neg_tf)

st.markdown(f'<h1 style="color:#D2691E;font-size:28px;">{"Positive Coef TF-IDF Words LR Model Output"}</h1>', unsafe_allow_html=True)
